...
var jsonData = [
  ...
  },
  {
    ...
    imageSrc: "./img/roadmap/i.svg",
    description:
      "Start marketing campaigns to attract players from Web2 and Web3.",
    future: true,
    current: false,
  },
  {
    ...
    imageSrc: "./img/roadmap/i.svg",
    description:
      "Development of the Lazy brand with a cute sloth as a main character to attract children’s attention to football and wellbeing.",
    future: true,
    current: false,
  },
  {
    ...
    imageSrc: "./img/roadmap/i.svg",
    description:
      "Implementation of gameplay elements from the GDD that were not included in the first versions of the application; AI Simulation of Matches; 3D Visualization of Matches.",
    future: true,
    current: false,
  },
  {
    ...
    imageSrc: "./img/roadmap/i.svg",
    description:
      "Attracting football influencers, local football stars for native promotion of the game.",
    future: true,
    current: false,
  },
  {
    ...
    imageSrc: "./img/roadmap/i.svg",
    description:
      "Creation of our own football school in one of the Central European countries, followed by the creation of our own team.",
    future: true,
    current: false,
  },
];
